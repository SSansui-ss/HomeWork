<template>
  <div>
    ...
    <div class="content">
      <p>商品名称
        <span>
          <el-input size="small" style="width:400px" placeholder="请输入内容" v-model="addlist.name">
          </el-input>
        </span>
      </p>
      <p>商品描述
        ...
        <span>
          <el-input size="small" style="width:400px" placeholder="请输入内容" v-model="addlist.subtitle">
          </el-input>
        </span>
      <p>
        所属分类
      ...
      <p>商品价格
        <span>
          <el-input type="number" size="small" style="width:300px" placeholder="请输入内容" v-model="addlist.price">
      ...
      <p>商品库存
        <span>
          <el-input type="number" size="small" dis style="width:300px;" placeholder="请输入内容" v-model="addlist.stock">
